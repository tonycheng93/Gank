...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     * 这个是最关键的函数，当程序中有未被捕获的异常，系统将会自动调用#uncaughtException方法 thread为出现未捕获异常的线程，e为未捕获的异常，有了这个e，我们就可以得到异常信息。
     */
    @Override
    ...
    private void dumpExceptionToSDCard(Throwable ex) throws IOException {
        ...
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            Debugger.d(TAG, "sdcard unmounted,skip dump exception");
            return;
        }
        ...
        try {
            ...
            Debugger.d(TAG, "dump crash info failed:" + e.toString());
        }
    }
